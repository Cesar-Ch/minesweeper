...
export function WinnerModal({user,time,selectedValue}) {
    ...
    return (
        <div className=" absolute  z-20  top-0 left-0 w-[100vw] h-[100vh] flex justify-center items-center " style={{ backgroundColor: 'rgba(0,0,0,.5)' }}>
            <article
                class=" flex flex-col justify-center items-center flex-colrounded-lg border border-gray-100 p-10 shadow-sm transition hover:shadow-lg bg-[#202020] dark:border-gray-800 dark:shadow-gray-200/25 sm:p-11 "
            >
                <span
                    class="flex justify-center items-center rounded bg-yellow-300 p-2 text-white dark:bg-yellow-400 "
                >
